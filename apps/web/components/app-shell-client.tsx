...
import { OrganizationWorkspaceBoundary } from "./organization-workspace-boundary";

export function AppShellClient({ children, clerkEnabled }: PropsWithChildren<{ clerkEnabled?: boolean }>) {
  return (
